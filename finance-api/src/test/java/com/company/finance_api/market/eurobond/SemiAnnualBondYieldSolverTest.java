...
class SemiAnnualBondYieldSolverTest {
  ...
  void nearParCouponBond_hasYieldNearCoupon() {
    ...
    BigDecimal y =
        SemiAnnualBondYieldSolver.annualPercentFromCleanPrice(
  ...
  void inverseYield_roundTripsToOriginalPrice() {
    ...
    BigDecimal y =
        SemiAnnualBondYieldSolver.annualPercentFromCleanPrice(price, coupon, asOf, maturity);
    assertThat(y).isNotNull();
    BigDecimal p2 =
        SemiAnnualBondYieldSolver.cleanPriceFromAnnualYieldPercent(y, coupon, asOf, maturity);
