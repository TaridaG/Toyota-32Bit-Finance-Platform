...
class PortalRegistrationServiceTest {
  ...
  void checkPortalDisplayUsernameAvailability_allowsSameUser() {
    ...
    var existing = new com.company.finance_api.domain.User("me@example.com", "trader");
  ...
  private static void setUserId(com.company.finance_api.domain.User user, UUID id) {
    try {
      var field = com.company.finance_api.domain.User.class.getDeclaredField("id");
