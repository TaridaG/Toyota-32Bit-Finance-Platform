...
/** YahooEurobondChartResponse — API transfer nesnesi (DTO/response/request). */
...
public record YahooEurobondChartResponse(Chart chart) {
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  public record Quote(List<Double> open, List<Double> high, List<Double> low, List<Double> close) {}
}
