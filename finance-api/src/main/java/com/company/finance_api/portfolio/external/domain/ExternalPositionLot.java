...
/** External portfolio içindeki tek alım lot'unu temsil eden JPA entity. */
@Getter
@Setter
@NoArgsConstructor
@Entity
...
public class ExternalPositionLot {
  ...
  /** Lot kaydını soft-delete ile işaretler. */
  public void softDelete() {
    this.deleted = true;
  }

  /** Birim fiyat, miktar ve komisyon dahil toplam maliyeti hesaplar. */
