package com.company.finance_api.pricing.domain;
...
/** InstrumentPrice — JPA domain entity (instrument price). */
public class InstrumentPrice {
  ...
  public InstrumentPrice(
      Instrument instrument, PriceType priceType, BigDecimal price, Instant timestamp) {
