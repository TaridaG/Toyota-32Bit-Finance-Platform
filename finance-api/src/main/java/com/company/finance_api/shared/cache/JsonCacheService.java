...
public interface JsonCacheService {
  ...
  /**
   * Verilen {@code cache key} için payload'ı okuyup hedef tipe deserialize eder.
   */
  <T> Optional<T> get(String key, TypeReference<T> typeReference);

  /**
   * Değeri JSON olarak serialize edip belirtilen {@code TTL} ile yazar.
   */
  void put(String key, Object value, Duration ttl);

  /**
   * Verilen {@code cache key} için mevcut girdiyi siler.
   */
