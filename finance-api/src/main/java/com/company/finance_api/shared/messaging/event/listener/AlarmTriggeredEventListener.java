package com.company.finance_api.shared.messaging.event.listener;
...
/** Alarm tetiklendiğinde bildirim ve outbox publish akışını başlatır. */
@Component
@RequiredArgsConstructor
public class AlarmTriggeredEventListener {

  private static final Logger log = LoggerFactory.getLogger(AlarmTriggeredEventListener.class);
