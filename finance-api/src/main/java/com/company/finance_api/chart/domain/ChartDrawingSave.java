package com.company.finance_api.chart.domain;
...
@Table(
    ...
    indexes = {
      @Index(
          name = "idx_chart_drawing_saves_user_asset_created",
          columnList = "user_id, asset_key, created_at")
    })
/** ChartDrawingSave — JPA domain entity (chart drawing save). */
