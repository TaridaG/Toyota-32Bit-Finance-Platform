...
/**
 * Kayıt e-posta doğrulama kodu TTL, cooldown ve hash secret ayarları ({@code
...
public class RegistrationVerificationProperties {
  ...
  /** E-posta footer'ında gösterilecek opsiyonel portal linki (örn. https://portal.example.com). */
