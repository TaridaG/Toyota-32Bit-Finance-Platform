...
/** Portal kullanıcı roster ve kayıt hızı metriklerini admin dashboard için toplar. */
@Service
public class AdminPortalUserMetricsService {
  ...
  /** Anlık kullanıcı metrics snapshot DTO'sunu üretir. */
  ...
  public AdminPortalUserMetricsDto snapshot() {
    ...
    return new AdminPortalUserMetricsDto(totalUsers, last7, prev7, wow, daily, deletionDaily, now);
  }
