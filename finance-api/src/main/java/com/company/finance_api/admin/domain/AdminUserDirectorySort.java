...
/** {@code sort} query parametresi için whitelist (ham kullanıcı girdisi sorguya eklenmez). */
public enum AdminUserDirectorySort {
  ...
  /** JPQL ORDER BY ifadesini döner. */
  public String jpqlOrder() {
    return jpqlOrder;
  }

  /** sortField ve sortDir bileşenlerinden güvenli sıralama enum'u üretir. */
    ...
    return switch (prop) {
      ...
      default ->
          throw new ResponseStatusException(
              HttpStatus.BAD_REQUEST, "Unsupported sort: " + sortParam);
    };
  }
}
