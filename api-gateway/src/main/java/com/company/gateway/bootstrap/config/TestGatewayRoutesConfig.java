 ...
 * Redis rate limiter ve circuit breaker olmadan integration test'lerin deterministik kalmasını sağlar.
 */
@Configuration
@Profile("test")
public class TestGatewayRoutesConfig {
    ...
    /**
     * Test ortamında upstream mock server'lara yönlendiren route locator bean'i.
     */
    @Bean
