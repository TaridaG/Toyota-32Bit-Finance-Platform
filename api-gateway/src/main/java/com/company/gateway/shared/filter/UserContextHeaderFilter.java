...
/**
 * JWT doğrulandıktan sonra downstream servislere güvenilir kullanıcı context header'ları enjekte eder.
 * Spoof edilmiş {@code X-USER-*} header'larını önce temizler.
 */
@Component
public class UserContextHeaderFilter implements GlobalFilter, Ordered {
    ...
    /** JWT claim adları ve roles path yapılandırması. */
    ...
    /**
     * İsteğe ait principal'dan güvenilir header'ları türetir veya spoof header'ları temizlenmiş haliyle devam eder.
     */
    @Override
    ...
    /** CorrelationId filter'ından sonra, request logging'den önce çalışır. */
    @Override
    public int getOrder() {
        return ORDER;
    }
