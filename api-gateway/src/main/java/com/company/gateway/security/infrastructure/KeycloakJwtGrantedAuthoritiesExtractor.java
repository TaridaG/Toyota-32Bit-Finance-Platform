...
/**
 * Keycloak JWT claim'lerinden Spring Security {@link GrantedAuthority} listesi üretir.
 * realm_access, resource_access, scope ve top-level roles kaynaklarını destekler.
 */
public final class KeycloakJwtGrantedAuthoritiesExtractor {
    ...
    /**
     * JWT içindeki tüm role kaynaklarını okuyup {@code ROLE_*} prefix'li authority set'ine dönüştürür.
     *
     * @param jwt doğrulanmış access token
     * @return Spring Security authority koleksiyonu
     */
