package com.company.newsservice.query.domain;
...
/**
 * Ingest edilmiş haber makalesi JPA entity'si ({@code news_articles}).
 */
public class NewsArticle {
    ...
    /** RSS HTML veya makale sayfası Open Graph'tan çözümlenen isteğe bağlı hero/thumbnail (çeviri için kullanılmaz). */
    @Column(length = 2000)
    ...
    /** UI filtreleri: bist, fx, crypto, macro, viop (cross-market impact). */
    @JdbcTypeCode(SqlTypes.JSON)
