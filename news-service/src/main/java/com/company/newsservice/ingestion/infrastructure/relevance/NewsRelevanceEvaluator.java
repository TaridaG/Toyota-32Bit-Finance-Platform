...
/**
 * Ingestion öncesinde haber öğelerinin domain'e uygunluğunu keyword skorlamasıyla değerlendirir.
 */
@Service
...
public class NewsRelevanceEvaluator {
    ...
    /**
     * Makalenin yapılandırılmış relevance kurallarına göre ingestion'a uygun olup olmadığını döner.
     *
     * @param item değerlendirilecek provider haber öğesi
     * @return relevant ise {@code true}
     */
