...
/**
 * Makale metni, kategori ve eşleşen sembollere göre UI topic tag'lerini ({@code bist}, {@code fx}, {@code crypto}, {@code macro}, {@code viop}) türetir.
 * Çapraz piyasa etkilerini destekler (Fed, savaş, emtia → macro + fx + bist).
 */
@Service
...
public class NewsTopicTagger {
    ...
    /**
     * Kategori, metin ve sembollere göre topic tag listesini çözer.
     *
     * @param primaryCategory RSS feed kategorisi
     * @param title makale başlığı
     * @param summary makale özeti
     * @param relatedSymbols enstrüman eşleşmesinden gelen semboller
     * @return sıralı, tekrarsız topic tag listesi
     */
