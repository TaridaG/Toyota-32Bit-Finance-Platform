...
/**
 * Keycloak realm/client rollerini Spring {@code ROLE_*} authority'lerine map eder (finance-api gateway ile aynı kurallar).
 */
public final class KeycloakJwtGrantedAuthoritiesExtractor {

    private KeycloakJwtGrantedAuthoritiesExtractor() {}

    /** JWT claim'lerinden (realm_access, resource_access, scope vb.) {@link GrantedAuthority} koleksiyonu üretir. */
