...
/**
 * RSS feed'lerindeki root-relative article path'lerini ({@code /haberler/...}) yayıncı site URL'ine tam path'e çevirir.
 */
public final class ArticleUrlNormalizer {
    ...
    /** Ham URL, feed URL ve kaynak adına göre mutlak makale link'i üretir. */
