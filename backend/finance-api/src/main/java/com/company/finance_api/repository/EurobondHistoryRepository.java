...
public interface EurobondHistoryRepository extends JpaRepository<EurobondHistory, Long> {
    ...
    List<EurobondHistory> findByIsinAndHistoryDateGreaterThanEqualOrderByHistoryDateAsc(String isin, LocalDate from);
    ...
    Optional<EurobondHistory> findFirstByIsinAndHistoryDateLessThanOrderByHistoryDateDesc(String isin, LocalDate historyDate);
}
