...
public class EurobondHistory {
    ...
    public static EurobondHistory newIngestRow(String isin, LocalDate historyDate, String sourceProvider) {
    ...
    /**
     * Persists OHLC (clean, 100 nominal) and derived yields; {@code changePercent} is day-on-day
     * move of clean close vs previous business day in this series.
     */
