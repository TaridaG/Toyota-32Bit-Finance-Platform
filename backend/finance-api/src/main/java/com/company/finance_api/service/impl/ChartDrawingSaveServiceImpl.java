...
public class ChartDrawingSaveServiceImpl implements ChartDrawingSaveService {
    ...
    public ChartDrawingSaveDetailDto create(CreateChartDrawingSaveRequest request) {
        ...
        ChartDrawingSave saved = chartDrawingSaveRepository.save(
    ...
    public List<ChartDrawingSaveSummaryDto> listForAsset(String assetKey) {
        ...
        return chartDrawingSaveRepository.findByUserIdAndAssetKeyOrderByCreatedAtDesc(userId, normalizedKey)
                .stream()
                .map(this::toSummary)
                .toList();
    }
    ...
    public ChartDrawingSaveDetailDto getById(Long id) {
        ...
        ChartDrawingSave row = chartDrawingSaveRepository.findByIdAndUserId(id, userId)
                .orElseThrow(() -> new ResourceNotFoundException("Chart drawing save not found: " + id));
        return toDetail(row);
    }
