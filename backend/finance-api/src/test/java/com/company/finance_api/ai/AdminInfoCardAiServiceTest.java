...
class AdminInfoCardAiServiceTest {
    ...
    void setUp() {
        ...
        service = new AdminInfoCardAiService(
                aiProperties,
                openAiClient,
    ...
    void complete_returnsOnlyGeneratedFieldsWithoutTitleOrShortDescription() {
        ...
        InfoCardAiContentResponse response = service.complete(new CompleteInfoCardAiRequest(
                "tr",
                "Tahvil",
                "Kisa aciklama",
                "BASIC_FINANCE",
    ...
    void translate_returnsAllFieldsInTargetLanguage() {
        ...
        InfoCardAiContentResponse response = service.translate(new TranslateInfoCardAiRequest(
                "tr",
                "en",
        ...
        verify(openAiClient).requestStructuredJson(
                eq("test-key"),
                modelCaptor.capture(),
                anyString(),
                anyString(),
    ...
    void complete_whenAiDisabled_throws() {
        ...
        assertThatThrownBy(() -> service.complete(new CompleteInfoCardAiRequest(
                "tr",
                "Tahvil",
                "Kisa",
                null,
