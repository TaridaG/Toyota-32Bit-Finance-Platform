package com.company.analytics.bootstrap.config.kafka;

import com.company.analytics.processing.domain.event.FxSnapshotUpdatedEvent;
import com.company.analytics.processing.domain.event.MarketPriceUpdatedEvent;
...
/** Analytics Kafka consumer, DLQ ve listener container yapılandırması. */
@Configuration
public class AnalyticsKafkaConsumerConfig {

    /** MarketPriceUpdatedEvent için Kafka consumer factory bean'i. */
    @Bean
    ...
    /** Dead-letter queue mesajları için Kafka producer factory bean'i. */
    @Bean
    ...
    /** DLQ topic'lerine mesaj göndermek için KafkaTemplate bean'i. */
    @Bean
    ...
    /** Retry ve DLQ yönlendirmeli Kafka hata işleyicisi. */
    @Bean
    ...
    /** Market price event consumer'ları için listener container factory bean'i. */
    @Bean
    ...
    /** FxSnapshotUpdatedEvent için Kafka consumer factory bean'i. */
    @Bean
    ...
    /** FX snapshot event consumer'ları için listener container factory bean'i. */
    @Bean
