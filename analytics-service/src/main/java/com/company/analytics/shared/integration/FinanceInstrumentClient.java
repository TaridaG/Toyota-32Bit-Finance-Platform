package com.company.analytics.shared.integration;
...
/** Finance API instrument katalog istemcisi; symbol ve instrument id çözümlemesi yapar. */
@Slf4j
@Component
...
public class FinanceInstrumentClient {
    ...
    /** Sembol için instrument id döner; bulunamazsa boş Optional. */
    ...
    /** Instrument id için sembol döner; bulunamazsa boş Optional. */
    ...
    private boolean loadCatalogFromFinanceApi() {
        try {
            ...
            log.warn("Failed to load instrument catalog from finance-api: {}", ex.getMessage());
            return false;
        }
    }
