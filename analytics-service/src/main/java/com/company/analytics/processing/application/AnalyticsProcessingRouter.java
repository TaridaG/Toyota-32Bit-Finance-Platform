...
/** Ham fiyat tipine göre candle, moving average, RSI ve trend işleme kararlarını yönlendiren router. */
@Component
public class AnalyticsProcessingRouter {
    ...
    /** Ham fiyat tipini bilinen sabit değerlerden birine normalize eder; bilinmeyen değerler UNKNOWN olur. */
