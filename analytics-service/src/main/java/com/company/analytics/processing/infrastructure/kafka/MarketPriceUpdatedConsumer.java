...
import com.company.analytics.processing.application.FeatureExtractionService;
...
/** Kafka {@code market.price.updated} topic'inden market price event'lerini tüketen consumer. */
@Slf4j
@Component
public class MarketPriceUpdatedConsumer {
    ...
    /**
     * Gerekli processing servisleri ve yapılandırmayı enjekte eder; coverage metriklerini kaydeder.
     *
     ...
     * @param featureExtractionService Feature extraction servisi
    ...
    /**
     * Market price event'ini alır, instrument çözümlemesi yapar ve analytics pipeline'ını çalıştırır.
     *
     * @param record Kafka consumer record; payload {@link MarketPriceUpdatedEvent}
     */
