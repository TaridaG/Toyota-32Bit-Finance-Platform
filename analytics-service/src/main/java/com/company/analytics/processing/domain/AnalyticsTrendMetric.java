...
/** Instrument için günlük trend yönü, momentum ve fiyat eğimi metriklerini saklayan JPA entity. */
@Entity
@Table(
...
public class AnalyticsTrendMetric {
    ...
    /**
     * Nötr trend yönü ile yeni bir trend metric kaydı oluşturur.
     *
     * @param instrumentId     Instrument kimliği
     * @param instrumentSymbol Instrument sembolü
     * @param tradeDate        İşlem tarihi
     * @return Yeni oluşturulmuş trend metric instance'ı
     */
    ...
    /**
     * Trend yönü, momentum ve fiyat eğimi değerlerini günceller.
     *
     * @param trendDirection Güncel trend yönü
     * @param momentum       Momentum değeri
     * @param priceSlope     Fiyat eğimi değeri
     */
    public void update(
