...
/** Günlük candle kapanış fiyatlarından moving average metriklerini hesaplayıp saklayan servis. */
@Service
...
public class MovingAverageServiceImpl implements MovingAverageService {
    ...
    /** Enstrüman için MA7, MA30 ve MA90 değerlerini hesaplayıp trade date bazında kaydeder. */
    @Transactional
    @Override
