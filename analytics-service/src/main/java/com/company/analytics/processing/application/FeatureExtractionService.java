...
import com.company.analytics.processing.domain.event.AnalyticsInsightEvent;
import com.company.analytics.processing.domain.event.AnalyticsMarketPriceEvent;
import com.company.analytics.processing.domain.AnalyticsFeatureSnapshot;
...
/** Candle geçmişinden volatility, momentum ve fiyat değişimi feature'larını çıkaran ve insight event üreten servis. */
@Slf4j
@Service
...
public class FeatureExtractionService {
    ...
    /** Market price event'inden feature snapshot üretir; devre dışıysa veya veri yetersizse boş döner. */
