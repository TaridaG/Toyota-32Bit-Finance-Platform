...
/**
 * finance-api catalog HTTP API üzerinden instrument symbol'lerini id'lere çözer.
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class FinanceInstrumentLookupClient {
    ...
    /**
     * Market symbol için internal instrument id'sini arar; bulunamazsa empty döner.
     */
