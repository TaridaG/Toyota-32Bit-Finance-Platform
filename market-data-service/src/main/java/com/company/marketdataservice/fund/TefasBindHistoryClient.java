...
/**
 * TEFAS fund history: prefers the post-migration JSON API {@code /api/funds/fonGnlBlgSiraliGetir}; falls back to the
 * legacy form POST {@code /api/DB/BindHistoryInfo} when {@link FundMarketProperties#getTefasFonGnlBlgUrl()} is blank
 * (e.g. tests with a mock server).
 */
@Component
