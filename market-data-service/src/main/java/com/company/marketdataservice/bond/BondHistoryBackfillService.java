...
/**
 * Loads TCMB EVDS Hazine yield history into {@code mds_market_price_history} without publishing Kafka
 * or mutating the live snapshot ring (unlike {@link com.company.marketdataservice.scheduler.BondPriceScheduler}).
 * <p>Uses EVDS daily frequency where configured, then forward-fills calendar days so charts and 1D logic see dense series.</p>
 */
@Service
