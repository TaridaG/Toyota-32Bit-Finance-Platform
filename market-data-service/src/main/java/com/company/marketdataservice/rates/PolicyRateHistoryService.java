...
/**
 * TCMB policy rate: weekly series persisted in {@code mds_tcmb_policy_rate_weekly}; EVDS is ingested by
 * {@link PolicyRateWeeklySyncService} on bootstrap / cron (full trailing-window refresh).
 */
@Service
