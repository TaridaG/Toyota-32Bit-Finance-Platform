...
import com.company.marketdataservice.dto.PolicyRatePointSourceQuality;
...
/**
 * Builds month-end (or clipped-to-range-end) policy-rate samples: last valid observation per month,
 * forward-fill across empty months, leading months before the first observation use the first value (PARTIAL).
 */
