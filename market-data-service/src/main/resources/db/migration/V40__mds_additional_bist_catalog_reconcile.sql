-- Reconcile catalog + Yahoo mappings when finance-api V45 ran after V39 (instruments did not exist yet).
...
from instruments i
where i.symbol in ('AKBNK', 'AVGYO', 'EREGL', 'BIMAS', 'TUPRS', 'ISCTR', 'SAHOL')
  and i.exchange = 'BIST'
