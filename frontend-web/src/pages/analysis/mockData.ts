...
export const assets: AssetDefinition[] = [
  { id: 'thy', symbol: 'THYAO', name: 'Turkish Airlines', type: 'stock', wireCategory: 'STOCK', marketSegment: 'bist', marketCap: 13_200_000_000 },
  { id: 'btc', symbol: 'BTC/USDT', name: 'Bitcoin', type: 'crypto', wireCategory: 'CRYPTO', marketSegment: 'crypto', marketCap: 2_130_000_000_000 },
  { id: 'usdtry', symbol: 'USDTRY', name: 'US Dollar / Turkish Lira', type: 'fx', wireCategory: 'FX', marketSegment: 'forex' },
  { id: 'gold', symbol: 'XAUUSD', name: 'Gold Spot', type: 'commodity', wireCategory: 'METAL', marketSegment: 'metals', marketCap: 18_000_000_000_000 },
  { id: 'bist', symbol: 'BIST100', name: 'Borsa Istanbul 100', type: 'index', wireCategory: 'INDEX', marketSegment: 'bist' },
]
